...
@interface NetAssociation : NSObject {
    ...
    NSDate                  *theServerDate;
    
    id<InternalGetDateDelegate> internalGetDateDelegate;
        
}

@property (readonly) BOOL               trusty;             // is this clock trustworthy
@property (readonly) double             offset;             // offset from device time (secs)
@property (nonatomic,retain) NSDate *theServerDate;
@property (nonatomic,retain) id<InternalGetDateDelegate> internalGetDateDelegate;
